document.addEventListener("DOMContentLoaded", function() {
    ...
    // Функция для мгновенного появления разделов сразу после пролистывания без задержек
    function revealSections() {
        ...
        sections.forEach((section) => {
            ...
            if (sectionTop < windowHeight * 0.98) {
                section.classList.add("visible"); // Мгновенное срабатывание анимации
            }
        });
    }
